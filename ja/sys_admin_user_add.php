...
if($dopost=='add')
{
    ...
    //后台管理员
    $avatar = uploadImg($_FILES['avatar']);
    $inquery = "INSERT INTO `#@__admin`(id,usertype,userid,pwd,uname,typeid,tname,email,avatar,intro)
                                                    VALUES('$mid','$usertype','$userid','$pwd','$uname','$typeid','$tname','$email','$avatar','$intro'); ";
