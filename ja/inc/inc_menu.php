...
<m:top item='1_' name='常用操作' display='block'>
  ...
  <m:item name='画报分类管理' link='category_main.php' rank='sys_Feedback' target='main' />
  <m:item name='内容回收站' link='recycling.php' ischannel='1' addalt='清空回收站' addico='img/gtk-del.png' linkadd='archives_do.php?dopost=clear&aid=no' rank='a_Recycling' target='main' />
</m:top>
...
<m:top item='1_' name='内容管理' display='block'>
  ...
  <m:item name='游戏库管理' ischannel='1' link='".$toolsUrl."/cmstools/gamedb/list' linkadd='spec_add.php' channelid='-1' rank='spec_New' target='main' />
  <m:item name='wiki统计' ischannel='1' link='wiki_list.php' linkadd='wiki_list.php' channelid='-1' rank='spec_New' target='main' />
  <m:item name='导入WIKI文章' ischannel='1' link='archives_wiki_list.php' linkadd='archives_wiki_list.php' channelid='-1' rank='spec_New' target='main' />
</m:top>
...
<m:top item='5_' name='自动任务' notshowall='1'  display='block' rank='sys_MakeHtml'>
  <m:item name='一键更新网站' link='makehtml_all.php' rank='sys_Group' target='main' />
  <m:item name='更新系统缓存' link='sys_cache_up.php' rank='sys_ArcBatch' target='main' />
  {$remoteMenu}
</m:top>
...
<m:top item='9_' name='内容设置' display='none' rank='member_List,member_Type'>
  <m:item name='阅读心情' link='joyme_readimg.php' rank='member_List' target='main' />
</m:top>
<m:top item='9_' name='WIKI词条' display='none'>
  <m:item name='WIKI列表' link='joyme_wiki.php' target='main' />
</m:top>
