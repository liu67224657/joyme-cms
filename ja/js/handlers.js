...
function addImage(src, pid){
	...
	var num = document.getElementsByClassName('albCt').length;
	newImgDiv.innerHTML += '<div style="margin-top:10px">注释：<input type="text" name="picinfo'+albImg+'" value="" style="width:'+iptwidth+'px;" /></div>';
	newImgDiv.innerHTML += '<div style="margin-top:10px">排序：<input type="text" name="imgorder'+albImg+'" value="'+num+'" style="width:'+iptwidth+'px;" /></div>';
}
