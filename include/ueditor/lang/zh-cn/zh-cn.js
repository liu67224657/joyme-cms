...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'drafts': '从草稿箱加载', 'charts': '图表', 'joymegame': '游戏库', 'huabaopid': '手游画报p标签','joymewiki':'WIKI导入'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
	...
	'joymegame':{
        'static':{
            'lang_input_tips':"输入游戏资料库名称",
            'J_searchBtn':{value:'搜索游戏'}
        },
        'emptyTxt':'未搜索到相关游戏结果，请换一个关键词试试。',
        'chapter':'ID',
        'singer':'游戏资料库名称'
    },
    'joymewiki':{
        'static':{
            'lang_input_tips':"输入WIKI条目地址"
        },
        'emptyTxt':'未搜索到相关条目结果。',
        'chapter':'ID'
    },
